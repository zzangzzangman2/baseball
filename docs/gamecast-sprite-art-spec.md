...
| --- | --- | --- | --- |
| 피부 | `#cf9a6a` | `#f2c79a` | `#ffe0b5` |
| 모자/팀색 | `#b23a48` | `#d23b3b` | `#ed6a5f` |
| 홈 유니폼 | `#dcdad2` | `#f7f7f2` | `#fffefb` |
| 원정 유니폼 | `#63615b` | `#8d8a82` | `#b9b6ad` |
| 바지 | `#242235` | `#3a3550` | `#5a5374` |
| 배트 | `#5f3f27` | `#8a5f39` | `#bb8750` |
| 글러브 | `#5f3f27` | `#704b2d` | `#a57243` |
...
| 예약색 | 의미 |
| --- | --- |
| `#20202a` | 가장 깊은 내부선/하드 아웃라인 |
| `#413d48` | 외곽 selout 기본색 |
| `#d23b3b` | 런타임 팀색 교체용 primary |
| `#b23a48` | 런타임 팀색 교체용 shadow/양말 |
| `#9dd7ff` | 야간 전용 상단 림라이트 |

순수 검정 `#000000`은 금지한다. 불투명 실루엣 경계는 `#20202a` 또는 `#413d48`의 1px selout으로 닫는다. 빌더는 외곽 경계의 selout 비율, 순수 검정, 예약색 근사치, 비허용 팔레트색을 검사한다. 팀색 교체 코드는 `#d23b3b`과 `#b23a48`만 대상으로 삼는다.

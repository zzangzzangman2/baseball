...
- 실행 시각: 2026-07-06T09:00:47.961Z
- 작업 폴더: C:\Users\godho\Downloads\baseball
- 실행 Node: C:\Program Files\nodejs\node.exe (v24.18.0)
- 대상 URL: http://127.0.0.1:57501/index.html
- 브라우저: chrome.exe
...
| 항목 | 결과 | 상세 | 위치 |
| --- | --- | --- | --- |
| 정적 로컬 서버 시작 | PASS | http://127.0.0.1:57501/index.html | - |
...
| 게임캐스트 랩 | PASS | desktop 800x720, feed 0/74, single-instance OK, speed-persist OK, pause/step OK, mobile canvas 305px | - |
| 브라우저 콘솔 에러 | PASS | 2개 콘솔 이벤트 수집, error 0건 | - |

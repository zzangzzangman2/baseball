...
- 실행 시각: 2026-07-16T04:48:10.164Z
- 작업 폴더: C:\Users\godho\Downloads\baseball
- 실행 Node: C:\Program Files\nodejs\node.exe (v24.18.0)
- 렌더링 검증 URL: http://127.0.0.1:53113/index.html
- 검증 렌더러: chrome.exe
...
| 항목 | 결과 | 상세 | 위치 |
| --- | --- | --- | --- |
| 정적 로컬 서버 시작 | PASS | http://127.0.0.1:53113/index.html | - |
...
| 게임캐스트 랩 | PASS | desktop 953x858, feed 0/77, single-instance OK, speed-persist OK, defense/skip/x4 OK, pause/step OK, playfeel ball 18/34, midview 800/920/1100, mobile canvas 305px, v2 anchors 18, players 10, v2 atlas/timeline 128-day/single, equipment catcher catcher_frame, runner idle @ 0px, v2 fx camera<=1.000, particles 0, underlays 3, inline default v2 960x720 | - |

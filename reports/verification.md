...
- 실행 시각: 2026-07-19T11:04:18.415Z
...
| 선수 누적 기록 모델 | PASS | 타자 90명/투수 30명 기록, 득점 40, PA 408, 투수아웃 268 | - |
| 경기 박스스코어/eventLog | PASS | game.final 5개, 박스스코어 5경기, PA 이벤트 408개, 정상 외야 장타 20개, 실책 1, 병살 4 | - |
| 타구별 비정상 장타/진루 차단 | PASS | 100 games/8106 PA audited; empty-base OF singles {"LF":271,"CF":173,"RF":260,"OF":0}; throw/base matrix passed | - |
| 게임캐스트 v3 모션 아틀라스 | PASS | layout v3, 활성 필드 field-jamsil-day 1개, 고유 모션 프레임 110개, pitch 24, swing 24, throw 12 | - |
| Legacy Gamecast corner fielding/base cover | PASS | specific 1B/3B slots preserved; P/1B/second-base receivers cover the throw target | - |
| 게임캐스트 v2 선언형 타임라인 | PASS | 12개 플레이, 108개 수비 조합, atlas anim 9키 | - |
| 하프이닝 경기 AI/작전 | PASS | 경기 81개, 희생번트 276, 대타 129, 세이브상황 CL 370/370, 9회말 생략 27, 끝내기 8 | - |
| 로테이션/불펜 운용 snapshot | PASS | 7일 선발 43명, 등판 투수 101명, SU 18, CL 10, W-L 30-30, SV 14, HLD 13 | - |
| 수동 투수 운용 우선 적용 | PASS | 수동 nextStarter 리오스, CL 미등판, 부상 슬롯 자동 보정 확인 | - |
...
| 포스트시즌/시상식 자동 생성 | PASS | 삼성 라이온즈 우승, PS 16경기, MVP 올러, GG 10명 | - |
...
| 자동 오프시즌/시즌 롤오버 | PASS | 자동 스토브 roster +55, 신인입단 55/보류권 110, FA 30건, CPU 트레이드 4건, 결재 0건 처리 후 2027 프리시즌 롤오버 | - |
| 롤오버 기록실 히스토리 보존 | PASS | 2026 leagueHistory 10팀, HR 최정, ERA 전용주, player.history 보존 | - |
...
| 10-game Gamecast event/cache identity | PASS | 10 games/809 PA; steals 1 SB/1 CS exact match, chronological order; top+bottom covered in 21 games; cache collision 0, wrong reuse 0, positions 1B/2B/3B/SS/LF/CF/RF | - |
